 ...
 setwd("C:\\Users\\Yi-Jay.Chang\\Desktop\\schaefer_r_Millar\\")
 ...
 Random = c("P_dev")
 parameters <- list(logR=-1.1, logK=8.0, logQ=-7.9, P_dev = rnorm(n,0,0), logSigmaProc=log(exp(0.1)), logSigmaObs=log(0.1))
 ...
 plot(hake$t,rep$B,ylim=c(0,5000),type="l",lty=2,col=2,ylab="Catch and Biomass",xlab="Year")
 points(hake$t,hake$C,type="l") 
 points(hake$t,rep$B+1.96*SD[30:53,2],type="l",lty=3,col=2)
 points(hake$t,rep$B-1.96*SD[30:53,2],type="l",lty=3,col=2)
